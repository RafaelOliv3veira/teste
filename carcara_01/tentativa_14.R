...
modelo <-"
functions {
 matrix kronecker_prod(vector A, matrix B) {
...
mu_tau_summary <- summary(fit, pars=c("QQ","q1","q2","q3","r1","r2","K1","K2","Sigma"), probs = c(0.025,0.5, 0.975))$summary
