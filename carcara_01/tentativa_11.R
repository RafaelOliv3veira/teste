...
Sigma ~ inv_wishart(1.1, diag_matrix(rep_vector(1,2)));
...
Sigma <- matrix(c(30^2, 20^2, 20^2, 20^2), nrow = 2, ncol = 2)
Lambda <- 0.005*Sigma
...
initf2 <- function(chain_id = 1) {
  list(q1 =Y[1,1]/rlnorm(1,3.5,0.0606) , q2 =Y[2,1]/rlnorm(1,3.5,0.0606) , sigma11 = rgamma(1,100,0.01), sigma22 = rgamma(1,100,0.01),
...
fit <- stan(model_code = modelo, 
            data=list( N=N, y=t(Y), x0= t(x0),mu=t(mu), I = I, I1 = I1, I2 = I2,Um=t(Um)), 
            iter=10000, chains=n_chains, init=init_ll, control = list(adapt_delta = 0.8));
...
mu_tau_summary <- summary(fit, pars=c( "q1","q2","r1","r2","K1","K2","Sigma"), probs = c(0.025,0.5, 0.975))$summary
mu_tau_summary
