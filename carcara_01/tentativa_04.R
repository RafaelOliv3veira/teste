...
fit <- stan(model_code = modelo, 
            data=list( N=N, y=t(Y), Sigma=Sigma, R=R, Lambda=Lambda, x0= t(x0), Q = Q, K = K, I = I, I1 = I1, I2 = I2,Um=t(Um)), 
...
mu_tau_summary <- summary(fit, pars=c( "x"), probs = c(0.025,0.5, 0.975))$summary
mu_tau_summary
