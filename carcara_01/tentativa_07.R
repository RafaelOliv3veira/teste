...
#Estimando os estados, a matriz diagonal R e as matrizes Sigma e Lambda
...
fit <- stan(model_code = modelo, 
            data=list( N=N, y=t(Y), K = K, x0= t(x0),mu=t(mu) ,Q = Q, I = I, I1 = I1, I2 = I2,Um=t(Um)), 
...
mu_tau_summary <- summary(fit, pars=c( "r1","r2","sigma1","sigma2"), probs = c(0.025,0.5, 0.975))$summary
mu_tau_summary
